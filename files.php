...
switch($params[0])
{
    case 'get_prod_export':
        ...
        $cmd[] = sprintf('tar -zchf %s %s', $tgzFilePath, $filesLocations);
    ...
    case 'prod_import':
        ...
        $confirm = ask(sprintf("Production files will be downloaded and expanded here %s, continue ? [y]: ", $filesLocations), true);
        if($confirm != "y") {
            echo "exiting...";
            exit;
        }
...
function help()
{
  ...
  echo "'prod_import' automatically get the tarball of shared files and expand it into your local project. \n";
